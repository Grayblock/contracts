...
contract NFT is Ownable, ERC721 {
    ...
    mapping (uint256 => TokenInfo) public extraInfoMap;
    ...
    function setTokenURI(uint256 _tokenId, string memory _tokenUri) public onlyOwner {
        ...
        emit TokenURIChange(_tokenId, _tokenUri);
        ...
        internal 
    {
        ...
        /// Save data
        extraInfoMap[_tokenIdTracker.current()] = TokenInfo({
        ...
        emit ItemCreated(_owner, _tokenIdTracker.current());
    }
